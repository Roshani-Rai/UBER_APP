...
function page() {
  ...
  // ✅ Fetch existing vehicle data on mount
  useEffect(() => {
      ...
      >
            ...
            {[0, 1, 2].map((i) => (
              <div
                ...
                className={`h-1.5 rounded-full transition-all ${
                  i === 0 ? 'w-8 bg-black' : 'w-8 bg-gray-200'
                }`}
              />
            ))}
          </div>
        ...
        <div className='mt-8 space-y-6'>
                  ...
                  <motion.button
                    ...
                    className={`group flex flex-col items-center justify-center gap-1.5 rounded-2xl border px-3 py-4 text-center transition-colors duration-200 ${
                      active
                        ...
                        : 'border-gray-200 hover:border-black hover:bg-black'
                    }`}
                  >
          ...
          {submitted ? (
            ...
            >
              {loading ? <CircleDashed size={17} className='text-white animate-spin' /> : "Save & Continue"}
            </motion.button>
          )}
        </div>
      </motion.div>
